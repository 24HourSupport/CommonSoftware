...
URL = r"""curl -f -A 'Mozilla/5.0 (X11; Linux x86_64; rv:96.0) Gecko/20100101 Firefox/96.0' -L https://www.amd.com/en/support/graphics/amd-radeon-6000-series/amd-radeon-6900-series/amd-radeon-rx-6900-xt --referer 'https://www.amd.com/en' | grep -Eo 'https?://\S+?\"' """
...
windows_driver_version = r"""wget -U 'Mozilla/5.0 (X11; Linux x86_64; rv:96.0) Gecko/20100101 Firefox/96.0' -qO- """ + "https://www.amd.com/en/support/kb/release-notes/rn-rad-win-" + latest_driver_version.replace('.','-') + """ | sed -e 's/<[^>]*>//g'"""
